<template>
    <div>
      <Sidebar/>
      <div class="imghome">
        <img src="../../assets/img/0089889.png" height="141px">
      </div>
      <div class="home">
        <div class="home_textarea">
          <div style="position: relative;height: 50px">
            <el-upload
              ...
              accept=".txt" style="top: 20px;float: right;position: absolute">
        ...
        <div class="home_some">
          ...
          <!--<div class="sometext1">-->
            ...
            <!--</div>-->
            <!--<el-button type="primary" size="mini" plain class="somebutton">导入</el-button>-->
          <!--</div>-->
        </div>
      </div>
    </div>
